...
COPY ../docker/torch-1.11-requirements.txt.patch $HOME/torch-1.11-requirements.txt.patch
RUN patch $PYTORCH/requirements.txt $HOME/torch-1.11-requirements.txt.patch && \
    rm $HOME/torch-1.11-requirements.txt.patch
