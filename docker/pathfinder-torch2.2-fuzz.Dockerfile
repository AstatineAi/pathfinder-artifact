...
RUN $PDG/build/bin/pathfinder-driver-generator --dll torch --dll_version 2.2 --output $HOME/pathfinder-torch-default && \
...
RUN $PDG/build/bin/pathfinder-driver-generator --dll torch --dll_version 2.2 --wo_staged --output $HOME/pathfinder-torch-wo_staged && \
