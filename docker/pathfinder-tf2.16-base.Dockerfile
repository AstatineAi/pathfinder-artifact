...
COPY ../docker/tf-2.16-WORKSPACE.patch $HOME/tf-2.16-WORKSPACE.patch
RUN patch $TENSORFLOW/WORKSPACE $HOME/tf-2.16-WORKSPACE.patch && \
    rm $HOME/tf-2.16-WORKSPACE.patch
