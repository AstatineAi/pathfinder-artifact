...
COPY ../docker/torch-2.2-requirements.txt.patch $HOME/torch-2.2-requirements.txt.patch
RUN patch $PYTORCH/requirements.txt $HOME/torch-2.2-requirements.txt.patch && \
    rm $HOME/torch-2.2-requirements.txt.patch
