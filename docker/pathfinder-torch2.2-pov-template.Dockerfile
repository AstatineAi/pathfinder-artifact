FROM pathfinder-torch2.2-pov-base
...
RUN $PDG/build/bin/pathfinder-driver-generator --dll torch --dll_version 2.2 --mode pov --buggy_input_dir $HOME/buggy_input --output $HOME/pathfinder-torch && \
