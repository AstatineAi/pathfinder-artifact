...
RUN $PDG/build/bin/pathfinder-driver-generator --dll tf --dll_version 2.16 --output $TENSORFLOW/tensorflow/core/kernels/pathfinder && \
    mv $TENSORFLOW/tensorflow/core/kernels/pathfinder/driver $TENSORFLOW/tensorflow/core/kernels/pathfinder/default

RUN $PDG/build/bin/pathfinder-driver-generator --dll tf --dll_version 2.16 --wo_staged --output $HOME/pathfinder-wo_staged && \
