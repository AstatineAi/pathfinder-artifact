FROM pathfinder-torch1.11-pov-base
...
RUN $PDG/build/bin/pathfinder-driver-generator --dll torch --dll_version 1.11 --mode pov --buggy_input_dir $HOME/buggy_input --output $HOME/pathfinder-torch && \
